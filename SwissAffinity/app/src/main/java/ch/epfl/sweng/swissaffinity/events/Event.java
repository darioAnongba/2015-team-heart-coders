...
public abstract class Event {
     ...
     * @throws IllegalArgumentException if one of the argument is null(for object) or negative (for int) or empty(for string and list)
     */
    private void checkParameters()throws IllegalArgumentException {
        if(id<0 ||id==0 || name.isEmpty()|| maxPeople==0 ||location==null || maxPeople<1 || basePrice<0 || animators.isEmpty() || imageEventURl==null || createdBy==null ||createdAt.after(dateBeginning)  || createdAt.after(dateEnd) || dateBeginning.after(getDateEnd()) ) {
