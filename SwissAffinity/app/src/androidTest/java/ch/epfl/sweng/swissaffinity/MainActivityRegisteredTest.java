...
@LargeTest
public class MainActivityRegisteredTest {
    ...
    public void testWelcomeText() {
        onView(withId(R.id.mainWelcomeText))
                .check(matches(withText(R.string.welcome_registered_text)));
    }

    @Test
    public void testButtonsDisplayed() {
        onView(withId(R.id.mainLoginButton))
                .check(matches(withEffectiveVisibility(Visibility.GONE)));
        onView(withId(R.id.mainRegisterButton))
                .check(matches(withEffectiveVisibility(Visibility.GONE)));
    }
}